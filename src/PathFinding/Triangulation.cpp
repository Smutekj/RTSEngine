...
//     : p_grid(&s_grid), boundary_(s_grid.cell_size_.x * s_grid.n_cells_.x, s_grid.cell_size_.x * s_grid.n_cells_.x)
// {
...
// void Triangulation::changeTypeOfConnectedTriangles(TriangleType type, sf::Vector2f pos,
//                                                    const std::vector<int> &tri_ind2component, const std::vector<std::vector<int>> &component2tri_inds)
// {
//     const auto clicked_tri_ind = findTriangle(static_cast<Vertex>(pos), false);

//     int clicked_component_ind = tri_ind2component.at(clicked_tri_ind);

//     for (const auto &tri_ind : component2tri_inds.at(clicked_component_ind))
//     {
//         triangles_.at(tri_ind).type = type;
//     }
// }
...
// {
//     if (tri.neighbours[next(ind_in_tri)] != -1)
//     {
