...
public:
    ...
    void draw(RenderWindow& window, const Transform& trans);
    void draw(RenderTexture& target, const Transform& trans);
...
public:
    ...
    Shader shader_textured = {s_vertexShaderSourceViewTransform, s_framgentShaderTexture};
