...
// [[nodiscard]] bool Font::loadFromFile(const std::filesystem::path& filename){
//     // FT_Face face;
...
//     {
//         throw std::runtime_error("Failed to load font from memory (failed to initialize FreeType)");
//         return false;
//     }
...
//                            &face) != 0)
//     {
//         throw std::runtime_error("Failed to load font from memory (failed to create the font face)");
//         return false;
//     }
...
//     {
//         throw std::runtime_error("Failed to load font from memory (failed to create the stroker)");
//         return false;
//     }
...
//     {
//         throw std::runtime_error("Failed to load font from memory (failed to set the Unicode character set)");
//         return false;
//     }
...
//         if (outlineThickness != 0)
//            throw std::runtime_error( "Failed to outline glyph (no fallback available)" );
//     }
...
//             const Vector2i textureSize = page.texture.size;
//             // if ((textureSize.x * 2 <= Texture::getMaximumSize()) && (textureSize.y * 2 <= Texture::getMaximumSize()))
//             // {
//                 // Make the texture 2 times bigger
//                 Texture newTexture;
//                 if (!newTexture.create({textureSize.x * 2, textureSize.y*2}))
//                 {
//                     throw std::runtime_error("failed to create new page texture");
//                     return {{0, 0}, {2, 2}};
//                 }
 
//                 // newTexture.setSmooth(m_isSmooth);
//                 newTexture.update(page.texture.getData(), static_cast<sf::Vector2u>(newTexture.size), {0,0});
...
//             if (!FT_IS_SCALABLE(face))
//             {
//                 throw std::runtime_error("Failed to set bitmap font size to  \nAvailable sizes are: ");
...
//             else
//             {
//                 throw std::runtime_error("Failed to set font size to ");
//             }
//         }
...
//     {
//        throw std::runtime_error("Failed to load font page texture");
//     }

//     texture.is_smooth = smooth;
// }
