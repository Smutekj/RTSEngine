...
namespace sf
{
    ...
    {
        return FloatRect(); // getTransform().transformRect(getLocalBounds());
    }

    ////////////////////////////////////////////////////////////
    Shape::Shape() : m_texture(NULL),
                     m_textureRect(),
    ...
    //////////////////////////////////////////////////////////
    void Shape::draw(RenderWindow& target) const
    {
